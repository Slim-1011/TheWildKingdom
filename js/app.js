(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".statement__slider")) {
            new swiper_core_Swiper(".statement__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: "1",
                ...
                speed: 800,
                navigation: {
                    prevEl: ".statement__swiper-button--prev",
                    nextEl: ".statement__swiper-button--next"
                },
                on: {}
            });
        }
